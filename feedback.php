...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $sql = "INSERT INTO tblfeedback (student_id, class_id, feedback) VALUES (:rollid, :classid, :feedback)";
                        ...
                        <div class="panel-body p-20">
                            <form action="feedback.php" method="post">
                                ...
                                <div class="form-group mt-20">
                                    <div class="">
                                        <button type="submit" class="btn btn-success btn-labeled pull-right">Submit Feedback<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
